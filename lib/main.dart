        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                calcbuttom('AC', Colors.green.shade400, Colors.black),
                calcbuttom('+/-', Colors.blue.shade400, Colors.black),
                calcbuttom('%', Colors.blue.shade400, Colors.black),
                calcbuttom('/', Colors.blue.shade400, Colors.black),
              ],
            ),
            ...
            Row(
              ...
              children: [
                ...
                calcbuttom('x', Colors.blue.shade400, Colors.black),
              ],
            ),
            const SizedBox(
              height: 10,
            ...
            Row(
              ...
              children: [
                ...
                calcbuttom('=', Colors.purple.shade300, Colors.black),
              ],
            ),
            const SizedBox(
              height: 10,
